    ...
    <>
      ...
      <div className="w-full relative grid grid-cols-1 gap-2 box-border p-2">
        <div className="flex flex-wrap gap-2 items-start">
          <div ref={dnd1.getList('aList')?.ref} className="w-full box-border p-2 bg-blue-200 pb-14 flex">
            {
        ...
        <div className="flex flex-wrap gap-2 items-start">
          <div ref={dnd1.getList('bList')?.ref} className="w-full box-border p-2 bg-blue-200 pb-14 flex">
            {
